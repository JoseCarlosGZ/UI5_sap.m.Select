		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sap.m.Select",
									"targetURL": "#josecarlossapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecarlossapui5-display": {
								"semanticObject": "josecarlossapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=josecarlos.sapui5",
									"url": sap.ui.require.toUrl("josecarlos/sapui5")
								}
							}
						}
					}
